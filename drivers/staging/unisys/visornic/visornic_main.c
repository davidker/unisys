...
static struct visor_channeltype_descriptor visornic_channel_types[] = {
	 ...
	 */
	{ VISOR_VNIC_CHANNEL_PROTOCOL_UUID, "ultravnic" },
	{ NULL_UUID_LE, NULL }
};
 ...
 * properly.
 */
MODULE_ALIAS("visorbus:" VISOR_VNIC_CHANNEL_PROTOCOL_UUID_STR);
...
static int visornic_probe(struct visor_device *dev)
{
	...
	features |= VISOR_IO_CHANNEL_IS_POLLING;
	features |= VISOR_IO_DRIVER_SUPPORTS_ENHANCED_RCVBUF_CHECKING;
