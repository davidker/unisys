 ...
 * @scsicmd: The scsicmd that needs aborted
 *
 * Returns SUCCESS if inserted, FAILED otherwise
 */
 ...
 * uiscmdrsp structure.
 *
 * Return: 0 if successfilly queued to the Service Partition, otherwise
 *	   error code
 */
static int
 ...
 * list of vdisks.
 *
 * Return: Success when created, otherwise error code
 */
