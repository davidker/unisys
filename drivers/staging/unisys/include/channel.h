...
#define VISOR_DRIVER_SUPPORTS_ALIGNED_IOCHANNEL_STRUCTS (0x1ULL << 9)

#define VISOR_USING_ALIGNED_IOCHANNEL_STRUCTS(features) \
	(((features) & VISOR_IOVM_SUPPORTS_ALIGNED_IOCHANNEL_STRUCTS) && \
	 ((features) & VISOR_DRIVER_SUPPORTS_ALIGNED_IOCHANNEL_STRUCTS))
