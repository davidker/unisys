...
// bit 7 is reserved
#define ULTRA_IO_IOVM_SUPPORTS_ALIGNED_IOCHANNEL_STRUCTS (0x1ULL << 8)
#define ULTRA_IO_DRIVER_SUPPORTS_ALIGNED_IOCHANNEL_STRUCTS (0x1ULL << 9)

#define ULTRA_IO_USING_ALIGNED_IOCHANNEL_STRUCTS(features) \
	(((features) & ULTRA_IO_IOVM_SUPPORTS_ALIGNED_IOCHANNEL_STRUCTS) && \
