 ...
 */
static struct input_dev * setup_client_keyboard(
					void *devdata, /* opaque on purpose */
...
static struct input_dev * setup_client_mouse(
					void *devdata /* opaque on purpose */)
{
	int xres, yres;
	struct fb_info *fb0;
 ...
 */
static void handle_locking_key(struct input_dev *visorinput_dev,
