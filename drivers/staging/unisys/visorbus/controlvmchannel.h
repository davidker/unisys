 ...
 * @completion_statue: Error status code or result of  message completion.
 * @struct flags:
 ...
 *
 * @addr:                             A physical address of something, that can
 *                                    be dereferenced by the receiver of this
 *                                    ControlVm command.
 *
 * @handle:                           A handle of something (depends on command
 *                                    id).
 */
